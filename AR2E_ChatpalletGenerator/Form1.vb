...
Public Class MainWindow
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If ofdJSON.ShowDialog() = DialogResult.OK Then
            ...
            For index = 1 To SkillList.Count
                ...
                DataGridView1.Rows(index - 1).Cells(1).Value = SkillList(index)("Type")
                DataGridView1.Rows(index - 1).Cells(2).Value = SkillList(index)("Category")
                DataGridView1.Rows(index - 1).Cells(3).Value = SkillList(index)("Name")
                DataGridView1.Rows(index - 1).Cells(4).Value = SkillList(index)("Lv")
                DataGridView1.Rows(index - 1).Cells(5).Value = SkillList(index)("Timing")
                DataGridView1.Rows(index - 1).Cells(6).Value = SkillList(index)("Note")
                DataGridView1.Rows(index - 1).Cells(7).Value = SkillList(index)("Roll")
                DataGridView1.Rows(index - 1).Cells(8).Value = SkillList(index)("Target")
                DataGridView1.Rows(index - 1).Cells(9).Value = SkillList(index)("Range")
                DataGridView1.Rows(index - 1).Cells(10).Value = SkillList(index)("Cost")
                DataGridView1.Rows(index - 1).Cells(11).Value = SkillList(index)("Reqd")
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim SkillList As Object = DataGridView1
        RichTextBox1.Text = ""
